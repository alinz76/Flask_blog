...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='FlaskBlog@demo.com', recipients=[user.email])

    msg.body = f"""To reset your password, visit the following link:
{url_for('request_reset', token=token, _external=True)}
...
def request_reset():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('rquest_reset_password.html', title='Reset Password', form=form)
